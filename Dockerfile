...
RUN conda create -n patchcore python==3.8 -y 

# Make RUN commands use the new environment:
SHELL ["conda", "run", "-n", "patchcore", "/bin/bash", "-c"]
...
WORKDIR /workspace
RUN git clone https://github.com/suren3141/patchcore-inspection
WORKDIR /workspace/patchcore-inspection
RUN pip install -e .

# WORKDIR /workspace
# RUN git clone --recurse-submodules https://github.com/suren3141/semantic-diffusion-model.git
