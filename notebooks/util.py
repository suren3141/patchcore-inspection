...
class ClusterModel():
    ...
    def score(self, x):
        ...
        mx_count = np.max(count)/np.sum(count)
...
def get_embeddings(train_features, val_features, emb_transform="umap", emb_kwargs=None):
    ...
    return scaled_train_features, scaled_val_features
...
def exp_cluster(cluster_model_name, cluster_model_kwargs, scaled_train_features=None, scaled_val_features=None, train_features=None, val_features=None, iterations=10, **kwargs):
    ...
    for it in tqdm(range(iterations)):
        ...
        if repeat_reducer:
            ...
            scaled_train_features, scaled_val_features = get_embeddings(train_features, val_features, kwargs["emb_transform"], emb_kwargs=kwargs["emb_kwargs"])
